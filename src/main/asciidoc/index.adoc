...
operation::create-event[snippets='request-fields,curl-request,http-reqeust, request-headers, http-response, response-headers, response-fields,links,http-response,links']
